 ...
 ***********************************************************************
 *
 * $Id: skills.c 11264 2012-04-18 19:01:15Z grunai $
...
void do_skin( CHAR_DATA *ch, char *argument )
{
    ...
    if ( !IS_SET( mob->parts, PART_SKIN ) || IS_SET( corpse->value[ 5 ], NO_SKIN ) )
    {
   ...
   // ch->position = POS_SITTING;
    ...
    else
    {
        ...
        skin->cost = skin_level * cost_multi * 3 * mob->skin_multiplier;
        ...
        skin->cost *= ( number_range( 6, 8 ) + number_range( 6, 8 ) )  * 35;
